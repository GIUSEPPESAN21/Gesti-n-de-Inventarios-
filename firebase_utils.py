...
# --- Lógica de Transacción Atómica (Función Independiente) ---
# Se define fuera de la clase para evitar conflictos con el decorador y 'self'.
@firestore.transactional
def _complete_order_atomic(transaction, db, order_id):
    """
    Contiene la lógica de la transacción. El decorador se encarga de todo.
    """
...
class FirebaseManager:
    ...
    def complete_order(self, order_id):
        ...
        """
        try:
            # Crea una referencia a la transacción
            transaction = self.db.transaction()
            # Llama a la función global, pasándole la transacción, la DB y el ID
